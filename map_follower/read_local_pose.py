...
class poseReader():
    def __init__(self):
        ...
        self._sub = rospy.Subscriber("/amcl_pose", LaserScan, self.lidarCB, queue_size=1)
...
if __name__ == '__main__':
    """Read amcl estimated pose of Rallycar respect to /map """

    print("Initializing node... ")
    rospy.init_node("read_amcl_pose")
    testReader = poseReader()
